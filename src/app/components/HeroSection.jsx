  ...
  return (
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          <h1 className="text-white mb-4 text-4xl sm:text-3xl lg:text-8xl lg:leading-normal font-extrabold">
          ...
          To put together my abilities and learning skills to best use and make my effective contribution to an organization for a bright career.
          ...
          <div>
            ...
            <Link
              target="_blank"
              href='https://sukrutha-resume-march.tiiny.site/'
